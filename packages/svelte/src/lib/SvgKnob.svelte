<script lang="ts" module>
	...
	export type DraggableProps = DraggableReactive & SvgKnobReactive & HTMLAttributes<HTMLDivElement>;
</script>
...
<script lang="ts">
	...
	let {
		...
		// SVG Knob props
		arcRadius = DEFAULT_MIN_ANGLE,
		bgColor = DEFAULT_BG_COLOR,
		circleRadius = DEFAULT_CIRCLE_RADIUS,
		disabledColor = DEFAULT_DISABLED_COLOR,
		maxAngle = DEFAULT_POINTER_LENGTH,
		minAngle = DEFAULT_ARC_RADIUS,
		pointerLength = DEFAULT_MAX_ANGLE,
		size = DEFAULT_SIZE,
